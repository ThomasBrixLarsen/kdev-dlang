...
K_PLUGIN_FACTORY_WITH_JSON(GoPluginFactory, "kdevgoplugin.json", registerPlugin<GoPlugin>(); )
    ...
    ILanguageSupport()
{
    ...
    qCDebug(Go) << "D Language Plugin is loaded\n";
...
{
    qCDebug(Go) << "Creating dlang parse job\n";
