...
#include "dparser/dparser.h"

typedef KDevelop::AbstractDeclarationBuilder<INode, IIdentifier, go::TypeBuilder> DeclarationBuilderBase;
...
private:
     ...
     */
    //void declareVariables(IIdentifier* id, go::IdListAst* idList, go::ExpressionAst* expression,
     ...
     */
    //void declareVariablesWithType(IIdentifier* id, go::IdListAst* idList, go::TypeAst* type, bool declareConstant);
     ...
     **/
    virtual go::GoFunctionDeclaration* declareFunction(IIdentifier* id, const go::GoFunctionType::Ptr& type,
