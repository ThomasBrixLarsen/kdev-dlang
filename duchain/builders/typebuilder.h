...
protected:
     ...
     **/
    virtual GoFunctionDeclaration* declareFunction(IIdentifier* id, const GoFunctionType::Ptr& type,
     ...
     **/
    go::GoFunctionDeclaration* parseSignature(IFunctionDeclaration* node, bool declareParameters, IIdentifier* name=0, const QByteArray& comment=QByteArray());
