...
GoFunctionType::GoFunctionType(GoFunctionTypeData &data) : FunctionType(data)
{
	
}

GoFunctionType::GoFunctionType(const GoFunctionType &rhs) : FunctionType(copyData<GoFunctionType>(*rhs.d_func()))
{
	
}

GoFunctionType::GoFunctionType() : FunctionType(createData<GoFunctionType>())
{
